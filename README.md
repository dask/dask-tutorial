...
If you're on a Mac you need to install particular versions of h5py and pytables:

    conda install numpy pandas h5py=2.4.0 pil matplotlib scipy toolz matplotlib pytables=3.1.1
